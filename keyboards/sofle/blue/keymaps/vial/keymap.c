...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_NAV] = LAYOUT(
        ...
        KC_CAPS, LGUI(KC_Z), LGUI(KC_X),    LGUI(KC_C),    LGUI(KC_V),    LGUI(KC_B), KC_TRNS, KC_TRNS,  LGUI(KC_K),     LGUI(KC_M),    LGUI(KC_C),    LGUI(KC_V),      RGUI(KC_X),       KC_ENT,
    ...
    [_FN] = LAYOUT(
        ...
        KC_CAPS,   KC_NO,         KC_MPRV,       KC_MPLY,       KC_MNXT,       KC_NO,   KC_TRNS, KC_TRNS,      C(S(KC_Z)),    C(S(KC_X)),    C(S(KC_C)),    C(S(KC_V)),     C(S(KC_B)),     C(S(KC_5)),
